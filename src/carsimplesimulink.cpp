...
void carsimplesimulink_step(void)
{
  ...
  if (carsimplesimulink_X.Integrator_CSTATE >
    ...
    rtb_BusAssignment.Data = carsimplesimulink_P.Saturation_UpperSat;
  } else if (carsimplesimulink_X.Integrator_CSTATE <
             carsimplesimulink_P.Saturation_LowerSat) {
    // BusAssignment: '<Root>/Bus Assignment'
    rtb_BusAssignment.Data = carsimplesimulink_P.Saturation_LowerSat;
  } else {
    // BusAssignment: '<Root>/Bus Assignment'
    rtb_BusAssignment.Data = carsimplesimulink_X.Integrator_CSTATE;
  }
...
void carsimplesimulink_initialize(void)
{
...

  {
    ...
    static const char_T tmp[6] = { '/', 'v', 'e', 'l', '_', 'x' };

    static const char_T tmp_0[9] = { 'c', 'm', 'd', '_', 'a', 'c', 'c', 'e', 'l'
    };

    // InitializeConditions for Integrator: '<Root>/Integrator'
    carsimplesimulink_X.Integrator_CSTATE = carsimplesimulink_P.Integrator_IC;
    ...
    Sub_carsimplesimulink_20.createSubscriber(&b_zeroDelimTopic_0[0], 1);
